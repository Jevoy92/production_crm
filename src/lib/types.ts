...
export type Subtask = { id: string; text: string; done: boolean; assignee?: string };
export type TaskAttachment = { id: string; name: string; kind: "doc" | "pdf" | "image" | "zip" | "other"; meta?: string };

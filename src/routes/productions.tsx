...
const PIPELINE_STAGES: Stage[] = ["Booked", "Pre-Production", "Shoot Day", "In Post", "Delivered"];
const STAGE_META: Record<string, { color: string; soft: string; border: string; dot: string }> = {
  Booked: { color: "text-violet", soft: "bg-violet/15", border: "border-violet/25", dot: "bg-violet" },
  "Pre-Production": { color: "text-amber", soft: "bg-amber/15", border: "border-amber/25", dot: "bg-amber" },
  "Shoot Day": { color: "text-rose", soft: "bg-rose/15", border: "border-rose/25", dot: "bg-rose" },
  "In Post": { color: "text-cyan", soft: "bg-cyan/15", border: "border-cyan/25", dot: "bg-cyan" },
  Delivered: { color: "text-emerald", soft: "bg-emerald/15", border: "border-emerald/25", dot: "bg-emerald" },
};

export function PipelineStats({ projects }: { projects: Project[] }) {
